	...
	<p class="text-warning">Connection request to {(user.username)}</p>
		...
		<tbody>
			<tr>
				...
				<td> 
					<select>
						{#each mentorskills as userskill}
							<option value={userskill.skillname}> {userskill.skillname} </option>
						{/each}	
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<select>
						{#each mentorskills as userskill}
								<option value={userskill.UserSkills.skilltype}> {userskill.UserSkills.skilltype} </option>
						{/each}	
				</select>
				</td>
			</tr>
